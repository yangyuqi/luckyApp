...
public class OkHttpClientManager {
    ...
    private OkHttpClientManager() {
        mOkHttpClient = new OkHttpClient.Builder()
                        .connectTimeout(Server.CONNECT_TIMEOUT, TimeUnit.SECONDS)
    ...
    public static <T> void postAsynJson(String url, final ResultCallback callback, T user) {
        String json = mGson.toJson(user);
        getInstance()._postAsyn(url, callback, json);
    }

    public static <T> void postAsynJson(String url, final ResultCallback callback, String json) {
        getInstance()._postAsyn(url, callback, json);
    }
    ...
    public static abstract class ResultCallback<T> {
        ...
        static Type getSuperclassTypeParameter(Class<?> subclass) {
            ...
            if (superclass instanceof Class) {
                throw new RuntimeException("ResultCallback Missing type parameter.");
            }
