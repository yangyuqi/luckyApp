...
public class TankDetailPresenter extends AbsPresenter<TankDetailInterlayer> {

    private String accesstoken ;
    private String id ;
    private Gson gson ;

    public TankDetailPresenter(Context context, TankDetailInterlayer interlayer ,String accessToken ,String mid) {
