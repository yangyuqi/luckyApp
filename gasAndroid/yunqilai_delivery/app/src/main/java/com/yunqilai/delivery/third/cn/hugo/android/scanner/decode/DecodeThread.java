...
import com.yunqilai.delivery.third.cn.hugo.android.scanner.config.Config;
...
final class DecodeThread extends Thread {
	...
	DecodeThread(ScanCodeFragment activity,
		...
		if (decodeFormats == null || decodeFormats.isEmpty()) {
			SharedPreferences prefs = PreferenceManager
					.getDefaultSharedPreferences(activity.getActivity());
