...
final class CameraConfigurationManager {
	...
	void initFromCameraParameters(Camera camera) {
		...
		// 改为此方式
		theScreenResolution = getDisplaySize(metric);
	...
	@SuppressLint("NewApi")
	private Point getDisplaySize(final DisplayMetrics metric) {
		final Point point = new Point();
		
		point.x = metric.widthPixels;
		point.y = metric.heightPixels;
