...
public class UserAttentionBean implements Serializable{
    ...
    public UserAttentionBean(String attestationId, String name, String phone, String idCardFront, String idCardBack, String idCardNumber, String status, String reason) {
